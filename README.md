...
| [已有任务移交到工作树](docs/230-local-to-worktree-handoff.md) | 干净本地检出中的任务可迁至托管工作树并继续 Codex Core 会话；反向见第 231 篇 |
| [工作树与本地检出的往返移交](docs/231-worktree-local-handoff.md) | 干净检出可双向移交并复用原工作树，提交只快进同步；未提交改动迁移与原生配对待补齐 |
