...
后续 [第 278 篇](278-browser-agent-screenshot.md) 补上当前视口截图回传模型，[第 279 篇](279-browser-agent-downloads.md) 补上同站链接下载与进度控制。跨 frame 控件、动态按钮下载、站点工具、CDP、敏感操作的完整分类审批，以及当前 Codex Mac 与 ShipiOS 的逐页原生视觉、焦点和键盘配对仍缺。电脑使用工具本轮读取桌面状态超时，不能将自动化测试计为原生验收。
